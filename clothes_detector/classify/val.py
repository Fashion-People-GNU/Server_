...
"""
Validate a trained YOLOv5 classification model on a classification yamls.
...
def run(
    data=ROOT / "../datasets/mnist",  # yamls dir
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "../datasets/mnist", help="yamls path")
