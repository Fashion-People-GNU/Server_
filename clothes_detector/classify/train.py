...
"""
Train a YOLOv5 classifier model on a classification yamls.
...
def train(opt, device):
    ...
    LOGGER.info(
        ...
        f'Starting {opt.model} training on {data} yamls with {nc} classes for {epochs} epochs...\n\n'
        f"{'Epoch':>10}{'GPU_mem':>10}{'train_loss':>12}{f'{val}_loss':>12}{'top1_acc':>12}{'top5_acc':>12}"
    )
    for epoch in range(epochs):  # loop over the yamls multiple times
...
def parse_opt(known=False):
    """Parses command line arguments for YOLOv5 training including model path, yamls, epochs, and more, returning
    parsed arguments.
    """
    ...
    parser.add_argument("--decay", type=float, default=5e-5, help="weights decay")
