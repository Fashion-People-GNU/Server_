...
"""
Train a YOLOv5 segment model on a segment yamls Models and datasets download automatically from the latest YOLOv5
release.
...
def train(hyp, opt, device, callbacks):
    """
    Trains the YOLOv5 model on a yamls, managing hyperparameters, model optimization, logging, and validation.
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/coco128-seg.yaml", help="yamls.yaml path")
